...
//     console.log(req);
//     const token = 'ya29.a0AfH6SMD57cLkmy6hnpMg_gNqnAH0mcng4UCAGaWiONqQZbaG9MgzthbMUlusXiK4RkSdM6JGDnT98QgeehbCjYWHbCptZ9woPAB_oALr9hpcVt8BSDFGYpZoDrSvC0YQyMfGGCwvLdjUmJFSp8r8453rREaejW0CSVY';
...
async function getUser1(remoteUser) {
  try{
    let userRec =await users.createUser(remoteUser);
